...
PushNotification.configure({
  ...
  onRegister: function (token) {
    ...
    {
      CleverTap.setPushToken(token, "FCM"); // Do this                       //method only for Android
    }
  },
...
export default class App extends Component {
  ...
  _recordEvent(event) {
    ...
    if (Platform.OS === 'android') {
       console.log("CleverTap FCM", CleverTap.FCM);
  ...
  _getDisplayUnitForId(event){
    CleverTap.profileGetCleverTapID('Unit Id', (err, res) => {
